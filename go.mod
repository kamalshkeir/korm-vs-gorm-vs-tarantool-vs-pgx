...
require (
	...
	github.com/kamalshkeir/korm v1.4.8
...
require (
	...
	github.com/kamalshkeir/kmux v1.6.9 // indirect
	github.com/kamalshkeir/ksbus v0.8.10 // indirect
	github.com/kamalshkeir/kstrct v1.4.8 // indirect
